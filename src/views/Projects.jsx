  ...
  const projectData = [
    {
      ...
      skills: "C++, Python, IoT, Starlink, DQN, Network Coverage, Signal Processing, 3GPP",
      description: [
    ...
    },
    {
      ...
      associatedWith: "UW-Madison",
      skills: "Python, Vector DB, Facebook AI Similarity Search(Faiss), Clustering Algorithms",
      description: [
    ...
    },
    {
      ...
      associatedWith: "UW-Madison",
      skills: "Python, Deep Learning, PyTorch, Bioinformatics",
      description: [
